...
public class PrefManager {
    ...
    public static void setLinkAudio(String user_info, Context context, String key) {
        SharedPreferences.Editor editor =  getSharedPreferences(context).edit();
        editor.putString(key+"A", user_info);
        editor.commit();
    }

    public static String getLinkAudio(Context ctx, String key){
        return getSharedPreferences(ctx).getString(key+"A", "");
    }
