...
public class Download {
    ...
    public void makeUplaod() throws IOException {
        ...
        riversRef.getFile(file).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
            ...
            public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                if(extension.equals("amr"))
                    PrefManager.setLinkAudio(file.getAbsolutePath(), context, key);
                else
                    PrefManager.setLinkMedia(file.getAbsolutePath(), context, key);
